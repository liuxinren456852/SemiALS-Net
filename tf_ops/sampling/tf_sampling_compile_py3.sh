...
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I $TF_INC -I $CUDA_PATH/include -I $TF_INC/external/nsync/public -lcudart -L $CUDA_PATH/lib64/ -L/home/mmvc/mmvc-ad-local/mmvc-ad-local-001/miniconda3/envs/XL_py3_cuda10/lib/python3.7/site-packages/tensorflow/ -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=1
